    ...
    draw: function(id, events, options) {
        ...
        svg.selectAll("circle")
            ...
            .attr("cx", function(d) {
                ...
                //Added description.
                tip.append("div").html('<p class="jobdescription">' + d.description + "<p>");
                tip.transition()
                    .duration(100)
                    .style("opacity", .9);
        ...
        //Adding start and end labels and heading.
        if (cfg.showLabels != false) {
            ...
            svg.append("text")
                .text(heading).style("font-size", "150%")
                .attr("x", (cfg.width - (cfg.width - 7)))
                .attr("y", (cfg.height / 3))
        }
